...
const Hero = () => {
  return (
    <div className="bg-[#090909] w-full h-screen text-stone-100 border border-blue-800 bg-[url('../assets/icon/bggrid.svg')] bg-fixed bg-no-repeat bg-center bg-cover flex flex-col">
      <Header />

      <div className=" w-[650px] m-auto flex flex-col items-center ">
        <motion.h1
          initial={{ scale: 0, rotate: 0, opacity: 0 }}
          animate={{ scale: 1, rotate: 360, opacity: 1 }}
          transition={{ duration: 0.5, ease: "backInOut" }}
          className={`${nun.className} text-[70px] font-bold`}
        >
          Man Like KayBams
        </motion.h1>
        <motion.h3
          ...
          className="text-[#A192E4] text-[50px]"
        >
          Product Designer
        </motion.h3>
        <motion.p
